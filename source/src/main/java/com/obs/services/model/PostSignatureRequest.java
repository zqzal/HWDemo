...
public class PostSignatureRequest
{
    ...
    {
        return "PostSignatureRequest [requestDate=" + requestDate + ", expiryDate=" + expiryDate + ", bucketName=" + bucketName
            + ", objectKey=" + objectKey + ", expires=" + expires + ", formParams=" + formParams + ", conditions=" + conditions + "]";
    }
