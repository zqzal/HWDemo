...
public class LifecycleConfiguration extends HeaderResponse
{
    ...
    public class Rule
    {
        ...
        public int hashCode()
        {
            ...
            result = prime * result + ((noncurrentVersionExpiration == null) ? 0 : noncurrentVersionExpiration.hashCode());
            result = prime * result + ((noncurrentVersionTransitions == null) ? 0 : noncurrentVersionTransitions.hashCode());
