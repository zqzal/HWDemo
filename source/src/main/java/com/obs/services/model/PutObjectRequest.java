...
public class PutObjectRequest extends PutObjectBasicRequest
{
	...
	public String toString() {
		return "PutObjectRequest [bucketName=" + bucketName + ", objectKey=" + objectKey + ", file=" + file + ", input="
				+ input + ", metadata=" + metadata + ", sseKmsHeader=" + sseKmsHeader + ", sseCHeader=" + sseCHeader
				+ ", acl=" + acl + ", expires=" + expires + ", successRedirectLocation=" + successRedirectLocation
				+ "]";
	}
